...
def main(**kwargs):
    try:
        ...
        parameters_list = {
            'AdminUserName':{
                'Key':None,
                'Default':aligo_configuration['AdminUserName'],
            },
            'AdminUserShell':{
                'Key':None,
                'Default':aligo_configuration['AdminUserShell'],
            },
            'BaseOS': {
                'Key': 'base_os',
        ...
        cfn_stack_body = fleet_cf_builder.main(**cfn_stack_parameters)
